<div class="antialiased bg-gray-50 text-gray-900 font-sans">
    ...
    <section class="w-full h-[80vh] md:h-[95vh] relative text-white flex flex-col items-center justify-end text-center p-8 overflow-hidden">
        ...
        <div class="absolute inset-0 z-0 bg-cover bg-center" style="background-image: url('//dynamik.org.uk/images/two-men-wearing-safety-vests-and-hard-hats-talking.jpg');"></div>
        ...
        <div class="relative z-20 max-w-4xl mx-auto mb-16 md:mb-24">
            ...
            <p class="text-xl sm:text-2xl md:text-3xl font-light leading-snug mt-4">
                We provide a comprehensive suite of electrical services designed to ensure the safety, efficiency, and reliability of your systems. From routine maintenance and emergency repairs to complete new installations and full-scale electrical system design, our certified professionals are dedicated to delivering exceptional results. We work across all sectors, offering customized solutions that meet your specific needs and exceed industry standards. Trust DYNAMIK to power your projects with expertise and a commitment to quality.
            </p>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-7xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 lg:gap-16">
                ...
                <div class="relative bg-gray-800 rounded-xl shadow-lg overflow-hidden flex flex-col p-8 transition transform hover:scale-105 duration-300">
                    <h3 class="text-3xl font-bold tracking-tight mb-2">Residential</h3>
                    <p class="text-gray-400 mb-6">
                        Seamless installations, repairs, and smart home solutions for your home.
                    </p>
                    <a href="#" class="mt-auto text-blue-400 hover:text-blue-200 transition-colors duration-200">
                        Learn more ›
                    </a>
                </div>
                <!-- Service 2 -->
                <div class="relative bg-gray-800 rounded-xl shadow-lg overflow-hidden flex flex-col p-8 transition transform hover:scale-105 duration-300">
                    <h3 class="text-3xl font-bold tracking-tight mb-2">Commercial</h3>
                    <p class="text-gray-400 mb-6">
                        Robust electrical systems and maintenance for businesses of all sizes.
                    </p>
                    <a href="#" class="mt-auto text-blue-400 hover:text-blue-200 transition-colors duration-200">
                        Learn more ›
                    </a>
                ...
                <!-- Service 3 -->
                <div class="relative bg-gray-800 rounded-xl shadow-lg overflow-hidden flex flex-col p-8 transition transform hover:scale-105 duration-300">
                    <h3 class="text-3xl font-bold tracking-tight mb-2">Industrial</h3>
                    <p class="text-gray-400 mb-6">
                        Complex power distribution and electrical solutions for industrial operations.
                    </p>
                    <a href="#" class="mt-auto text-blue-400 hover:text-blue-200 transition-colors duration-200">
                        Learn more ›
                    </a>
