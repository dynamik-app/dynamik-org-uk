<div class="max-w-5xl mx-auto py-10 px-4 sm:px-6 lg:px-8 space-y-8">
    ...
    @if (empty($items))
        <div class="text-center py-16 bg-white shadow rounded-lg">
            ...
            <p class="mt-2 text-gray-600">{{ __('Browse our products to add items to your cart.') }}</p>
            <div class="mt-4">
    ...
    @else
        <div class="bg-white shadow rounded-lg">
            ...
            <div class="p-6 border-t border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
