<nav x-data="{ open: false }" class="bg-gray-900 border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="py-4">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-3">
                    <a href="{{ url('/') }}" class="flex items-center gap-3">
                        ...
                        <span class="text-white text-lg font-semibold">{{ config('app.name', 'DYNAMIK') }}</span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex items-center space-x-8 border-t border-gray-800 pt-3 mt-2">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('learn.dashboard') }}" :active="request()->routeIs('learn.*')" class="text-white">
                {{ __('Learn') }}
            </x-responsive-nav-link>
        </div>
