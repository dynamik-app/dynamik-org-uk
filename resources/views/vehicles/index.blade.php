<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('vehicles.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md shadow hover:bg-blue-700">Add vehicle</a>
        </div>
    </x-slot>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    @if ($vehicles->isEmpty())
                        <p class="text-gray-600">No vehicles tracked yet.</p>
                    @else
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @foreach ($vehicles as $vehicle)
                                        <tr>
                                            ...
                                            <td class="px-4 py-2">{{ trim(($vehicle->make ?: '') . ' ' . ($vehicle->model ?: '')) ?: '—' }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
